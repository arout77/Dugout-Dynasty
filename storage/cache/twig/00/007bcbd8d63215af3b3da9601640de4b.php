...
/* game/playball.twig */
class __TwigTemplate_5d83c75fc70045983a80027bc8fbd71a extends Template
{
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 4
        yield "<div class=\"min-h-screen bg-gray-900 text-white font-sans overflow-hidden flex flex-col\" id=\"game-interface\">
    ...
    <div class=\"bg-gray-800 border-b border-gray-700 p-2 shadow-lg z-50\">
        ...
        // line 13
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["state"] ?? null), "teams", [], "any", false, false, false, 13), "away", [], "any", false, false, false, 13), "name", [], "any", false, false, false, 13), "html", null, true);
        yield "</div>
                    <div class=\"text-3xl font-mono font-bold text-yellow-400\" id=\"score-away\">";
        // line 14
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["state"] ?? null), "score", [], "any", false, false, false, 14), "away", [], "any", false, false, false, 14), "html", null, true);
        yield "</div>
                </div>
                ...
                <div class=\"text-center w-16\">
                    <div class=\"text-[10px] text-gray-400 font-bold uppercase truncate\">";
        // line 18
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["state"] ?? null), "teams", [], "any", false, false, false, 18), "home", [], "any", false, false, false, 18), "name", [], "any", false, false, false, 18), "html", null, true);
        yield "</div>
                    <div class=\"text-3xl font-mono font-bold text-yellow-400\" id=\"score-home\">";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["state"] ?? null), "score", [], "any", false, false, false, 19), "home", [], "any", false, false, false, 19), "html", null, true);
        yield "</div>
                </div>
            </div>
                ...
                <div class=\"flex flex-col items-center w-16\">
                    ...
                    <div class=\"flex items-center gap-1 text-xl font-bold\">
                        <span id=\"inning-arrow\" class=\"text-yellow-500 text-sm\">
                            ";
        // line 29
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["state"] ?? null), "half", [], "any", false, false, false, 29) == "top")) {
            yield "▲";
        } else {
            yield "▼";
        }
        ...
        yield "                        </span>
                        <span id=\"inning-num\">";
        // line 31
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["state"] ?? null), "inning", [], "any", false, false, false, 31), "html", null, true);
        yield "</span>
                    </div>
                </div>
    ...
    <div class=\"container mx-auto max-w-7xl p-4 grid grid-cols-1 lg:grid-cols-12 gap-4 flex-grow\">
        ...
        yield "/public/img/stadium.jpg\" alt=\"Stadium\" class=\"absolute inset-0 w-full h-full object-cover opacity-80\">
                ...
                <div class=\"absolute top-[55%] left-[50%] transform -translate-x-1/2 z-30 text-center\">
                    <span class=\"bg-blue-900/90 text-white text-xs px-3 py-1 rounded-full shadow border border-blue-500 backdrop-blur-sm font-bold\">";
        // line 93
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["pitcher"] ?? null), "player_name", [], "any", false, false, false, 93), "html", null, true);
        yield "</span>
                    <div class=\"text-[10px] text-yellow-400 mt-0.5 font-mono bg-black/50 rounded px-1 inline-block\">";
        // line 94
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, ($context["pitcher"] ?? null), "ERA", [], "any", false, false, false, 94), 2), "html", null, true);
        yield " ERA</div>
                </div>
            </div>
            ...
            <div class=\"absolute bottom-4 left-4 right-4 bg-gray-800/90 backdrop-blur p-3 rounded-lg border border-gray-600 flex justify-between items-center z-40 shadow-xl\">
                <div>
                    ...
                    <div class=\"text-lg font-bold text-white leading-tight\" id=\"batter-name\">";
        // line 102
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["batter"] ?? null), "player_name", [], "any", false, false, false, 102), "html", null, true);
        yield "</div>
                    <div class=\"text-xs text-gray-400 font-mono mt-0.5\">
                        AVG <span class=\"text-white font-bold\" id=\"batter-avg\">";
        // line 104
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, ($context["batter"] ?? null), "AVG", [], "any", false, false, false, 104), 3), "html", null, true);
        yield "</span> <span class=\"mx-1\">|</span> 
                        HR <span class=\"text-white font-bold\" id=\"batter-hr\">";
        // line 105
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["batter"] ?? null), "HR", [], "any", false, false, false, 105), "html", null, true);
        yield "</span>
                    </div>
                </div>
                ...
                <div class=\"text-right\">
                     ...
                     <div class=\"text-sm text-white font-bold truncate w-32 text-right\">";
        // line 111
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["pitcher"] ?? null), "player_name", [], "any", false, false, false, 111), "html", null, true);
        yield "</div>
                </div>
            </div>
        </div>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["state"] ?? null), "log", [], "any", false, false, false, 146));
        foreach ($context['_seq'] as $context["_key"] => $context["line"]) {
            // line 147
            yield "                        <div class=\"opacity-90 border-b border-gray-800/50 pb-1\">";
...
";
    ...
    {
        return array (  268 => 157,  258 => 149,  249 => 147,  245 => 146,  207 => 111,  198 => 105,  194 => 104,  189 => 102,  178 => 94,  174 => 93,  150 => 72,  106 => 31,  103 => 30,  97 => 29,  84 => 19,  80 => 18,  73 => 14,  69 => 13,  58 => 4,  51 => 3,  40 => 1,);
    }
...
{% endblock %}", "game/playball.twig", "C:\\MAMP\\htdocs\\dugout\\views\\themes\\americana\\game\\playball.twig");
    }
}
